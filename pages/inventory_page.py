...
class InventoryPage(BasePage):
    ADD_TO_CART_SELECTOR = '.inventory_item_description:has-text("Sauce Labs Fleece Jacket") button:has-text("Add to cart")'
    ...
    def add_first_item_to_cart(self):
        ...
        self.assert_element_is_visiable(self.SHOPPING_CART_LINK_SELECTOR)
